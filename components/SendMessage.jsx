	...
	return (
		<div className='aboslute group bottom-0 mt-3 flex h-12 w-full items-center  bg-gray-100 sm:h-20'>
			<form
				...
				className='mx-auto flex h-[80%] w-[95%] items-center  rounded-full border-[1.5px] border-gray-500 bg-white  text-xl'>
				<input
					value={input}
					onChange={(e) => setInput(e.target.value)}
					className='h-1/2 w-full  rounded-full border-none p-3 text-xl text-gray-900 caret-blue-400 outline-none placeholder:text-center  placeholder:font-["Source_Sans_Pro"] placeholder:text-2xl placeholder:font-semibold placeholder:text-gray-800/[.8] group-hover:w-[80%] group-hover:placeholder:text-xl sm:placeholder:text-3xl group-hover:sm:placeholder:text-2xl'
					type='text'
